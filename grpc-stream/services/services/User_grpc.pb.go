...
type UserServiceClient interface {
	...
	GetUserScoreByDoubleEndStream(ctx context.Context, opts ...grpc.CallOption) (UserService_GetUserScoreByDoubleEndStreamClient, error)
}
...
func (c *userServiceClient) GetUserScoreByDoubleEndStream(ctx context.Context, opts ...grpc.CallOption) (UserService_GetUserScoreByDoubleEndStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[2], "/services.UserService/GetUserScoreByDoubleEndStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceGetUserScoreByDoubleEndStreamClient{stream}
	return x, nil
}

type UserService_GetUserScoreByDoubleEndStreamClient interface {
	Send(*UserScoreRequest) error
	Recv() (*UserScoreResponse, error)
	grpc.ClientStream
}

type userServiceGetUserScoreByDoubleEndStreamClient struct {
	grpc.ClientStream
}

func (x *userServiceGetUserScoreByDoubleEndStreamClient) Send(m *UserScoreRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userServiceGetUserScoreByDoubleEndStreamClient) Recv() (*UserScoreResponse, error) {
	m := new(UserScoreResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type UserServiceServer interface {
	...
	GetUserScoreByDoubleEndStream(UserService_GetUserScoreByDoubleEndStreamServer) error
...
func (UnimplementedUserServiceServer) GetUserScoreByDoubleEndStream(UserService_GetUserScoreByDoubleEndStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method GetUserScoreByDoubleEndStream not implemented")
}
...
func _UserService_GetUserScoreByDoubleEndStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserServiceServer).GetUserScoreByDoubleEndStream(&userServiceGetUserScoreByDoubleEndStreamServer{stream})
}

type UserService_GetUserScoreByDoubleEndStreamServer interface {
	Send(*UserScoreResponse) error
	Recv() (*UserScoreRequest, error)
	grpc.ServerStream
}

type userServiceGetUserScoreByDoubleEndStreamServer struct {
	grpc.ServerStream
}

func (x *userServiceGetUserScoreByDoubleEndStreamServer) Send(m *UserScoreResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userServiceGetUserScoreByDoubleEndStreamServer) Recv() (*UserScoreRequest, error) {
	m := new(UserScoreRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetUserScoreByDoubleEndStream",
			Handler:       _UserService_GetUserScoreByDoubleEndStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
